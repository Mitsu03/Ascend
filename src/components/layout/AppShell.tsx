...
function BottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 border-t border-void-700 bg-void-850/95 pb-[calc(1.625rem+env(safe-area-inset-bottom))] backdrop-blur-xl md:hidden"
